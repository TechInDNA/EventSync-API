...
echo ""
echo "--- Test 12: Name with SQL injection attempt (should return 422) ---"
...
echo "--- Test 13: Malformed JSON (should return 400) ---"
...
echo "--- Test 14: Empty body, name missing (should return 422) ---"
curlie -k -b /tmp/curlie_cookies.txt -H "Content-Type: application/json" -d '{}' http://localhost:8080/rooms

echo ""
echo "--- Test 15: Wrong field name (should return 422 since name is missing) ---"
