-- ═══════════════════════════════════════════════════════════════════════
--  Seed data for testing POST /sessions/{id}/speaker/{id}
--  Creates a room, event, session, and speaker to use in the test.
--  UUIDs generated via uuidgen.
-- ═══════════════════════════════════════════════════════════════════════

INSERT INTO eventsync_app.room (id, name)
VALUES ('00107bc0-8e75-406e-b534-c1d0f17a4803', 'SessionSpeaker Test Room')
...
VALUES (
    ...
    'SessionSpeaker Test Event',
    'Event for testing POST /sessions/{id}/speaker/{id}.',
...
VALUES (
    ...
    'SessionSpeaker Test Session',
    'Session for testing speaker link via POST /sessions/{id}/speaker/{id}.',
...
VALUES (
    ...
    'SessionSpeaker',
    'Tester',
    'sessionspeaker.tester@example.com',
    'Speaker for testing POST /sessions/{id}/speaker/{id}.',
