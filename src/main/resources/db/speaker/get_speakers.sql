...
-- Speakers 6-7: have external links
-- Speakers 8-10: no external links
--
-- Usage:
--   psql -f src/main/resources/db/speaker/get_speakers.sql
--
...
-- ============================================================
-- Speaker 6: with 3 external links, no profile picture
-- ============================================================
INSERT INTO eventsync_app."user" (id, first_name, last_name, email, bio, profile_picture, role)
VALUES (
    '03bd2b2e-7a52-446b-abbf-d0f4c1d66fec',
    'Linus',
    'Torvalds',
    'linus.torvalds@example.com',
    'Creator of Linux and Git — the tools that power modern development.',
    NULL,
    'SPEAKER'
)
ON CONFLICT (email) DO NOTHING;
...
INSERT INTO eventsync_app.external_links (name, url, user_id)
VALUES
    ('GitHub',    'https://github.com/torvalds',       '03bd2b2e-7a52-446b-abbf-d0f4c1d66fec'),
    ('Wikipedia', 'https://en.wikipedia.org/wiki/Linus_Torvalds', '03bd2b2e-7a52-446b-abbf-d0f4c1d66fec'),
    ('Personal',  'https://lkml.org/',                 '03bd2b2e-7a52-446b-abbf-d0f4c1d66fec')
ON CONFLICT (url) DO NOTHING;

-- ============================================================
-- Speaker 7: with 1 external link, no bio
-- ============================================================
INSERT INTO eventsync_app."user" (id, first_name, last_name, email, bio, profile_picture, role)
VALUES (
    '303b483c-f7f3-41a3-bd68-9d0aa84822d1',
    'Dennis',
    'Ritchie',
    'dennis.ritchie@example.com',
    NULL,
    'https://example.com/avatars/dmr.jpg',
    'SPEAKER'
)
ON CONFLICT (email) DO NOTHING;
...
-- ============================================================
-- Speaker 8: no external links, full profile
-- ============================================================
INSERT INTO eventsync_app."user" (id, first_name, last_name, email, bio, profile_picture, role)
VALUES (
    '68808755-8138-411e-b79d-59f51e8d5c35',
    'Barbara',
    'Liskov',
    'barbara.liskov@example.com',
    'Turing Award winner — formulated the Liskov Substitution Principle.',
    'https://example.com/avatars/liskov.jpg',
    'SPEAKER'
)
ON CONFLICT (email) DO NOTHING;

-- ============================================================
-- Speaker 9: no external links, minimal profile (no pic, no bio)
-- ============================================================
INSERT INTO eventsync_app."user" (id, first_name, last_name, email, bio, profile_picture, role)
VALUES (
    '5236174a-91d1-4e0c-9075-603c26cf7536',
    'Edsger',
    'Dijkstra',
...
-- ============================================================
-- Speaker 10: no external links, with all optional fields
-- ============================================================
INSERT INTO eventsync_app."user" (id, first_name, last_name, email, bio, profile_picture, role)
VALUES (
    '06e3b52b-a446-4a56-8cf6-972c5c03209a',
    'Barbara',
    'McClintock',
    'barbara.mcclintock@example.com',
    'Nobel Prize-winning geneticist who discovered transposons.',
    'https://example.com/avatars/mcclintock.jpg',
    'SPEAKER'
)
ON CONFLICT (email) DO NOTHING;
